  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-gray-100">
      ...
      <div className="flex items-center justify-center gap-5 px-6 py-3.5 sm:gap-8 sm:py-5">
        {[
          { label: "Target", value: "$20K", iconColor: "#D92D20" },
          { label: "Revenue", value: "$20K", iconColor: "#039855" },
          { label: "Today", value: "$20K", iconColor: "#039855" },
        ].map((item, i) => (
          <div key={i} className="flex items-center gap-5">
            {i !== 0 && <div className="w-px bg-gray-200 h-7"></div>}
            <div>
